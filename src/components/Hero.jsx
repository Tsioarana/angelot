...
const Hero = () => {
  ...
  <div className="flex-1">
    ...
    <p className={`${styles.heroSubText} mt-2 text-white-100`} style={{ fontSize: '1.2rem', lineHeight: "35px" }}>
      Je suis Pascal, développeur web passionné, spécialisé dans les technologies front-end et Back-end. Avec une expertise en création de sites web modernes et performants.
    </p>
  </div>
